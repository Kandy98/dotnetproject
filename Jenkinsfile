        ...
        stage('SonarQube') {
            steps {
                withSonarQubeEnv('sonarqube') {
                    ...
                    bat """dotnet SonarScanner begin /k:KanvermaCoreProject /d:sonar.host.url=http://localhost:9000 /d:sonar.login="98c8246a752ec6ed8e41ff503125f7095413ab84
" /d:sonar.cs.opencover.reportsPaths="./FirstCoreProject/coverage.opencover.xml" /d:sonar.coverage.exclusions="**Test*.cs"""
